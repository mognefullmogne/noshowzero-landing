      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-xl shadow-blue-600/30 transition-shadow hover:shadow-2xl hover:shadow-blue-600/40"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 flex h-[520px] w-[380px] flex-col overflow-hidden rounded-2xl border border-black/[0.08] bg-white shadow-2xl sm:bottom-6 sm:right-6 max-sm:inset-4 max-sm:h-auto max-sm:w-auto"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-black/[0.04] bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4">
            ...
            <form
              ...
              className="flex items-center gap-2 border-t border-black/[0.04] px-4 py-3"
            >
              <input
                type="text"
                value={input}
              ...
              <Button
                ...
                className="h-8 w-8 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white disabled:opacity-50"
              >

    ...
    <div className="flex gap-8">
      ...
      <div className="flex-1 min-w-0 space-y-12">
        ...
        <section id="how-it-works">
          <h1 className="text-2xl font-bold text-gray-900">How NoShow Works</h1>
          <p className="mt-2 text-gray-600 leading-relaxed">
            NoShow plugs into your existing scheduling software and <strong>runs entirely on autopilot</strong>.
              ...
              {[
                {
                  ...
                  desc: "A client books via your website, app, or front desk. Your system sends the appointment data to NoShow automatically.",
                  color: "blue",
                },
                {
                  step: "2",
                  title: "NoShow AI takes over",
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-600 mt-0.5">
                  After the one-time setup, your scheduling software talks to NoShow in the background.
        ...
        <section id="no-code">
          ...
          <p className="mt-2 text-sm text-gray-600">
            If you don&apos;t have custom scheduling software and just want to use NoShow directly,
          ...
          <div className="mt-6 rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Use the NoShow Dashboard</h3>
                <p className="mt-1 text-sm text-gray-600 leading-relaxed">
                  Log in to your NoShow account, add appointments through our web interface,
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-600 mt-0.5">
                  ...
                  an EHR, a booking platform, or a custom app) that want to integrate NoShow automatically.
        ...
        <section id="quick-start">
          ...
          <p className="mt-2 text-sm text-gray-600">
            If you have existing scheduling software, a developer connects it to NoShow <strong>once</strong>.
            After that, everything is automatic — your software sends appointments to NoShow, and NoShow handles the rest.
          </p>
          ...
          <div className="mt-6 space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Wherever your software creates a new appointment, add a call to NoShow.
...
async function onAppointmentCreated(appointment) {
  // Send the appointment to NoShow — AI handles the rest
...
def on_appointment_created(appointment):
    ...
    # Done! NoShow AI takes it from here.`} />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  If a client cancels through your software, tell NoShow so the AI can instantly offer the slot to the next person on the waitlist:
                </p>
...
async function onAppointmentCancelled(appointmentId, reason) {
  ...
  // → NoShow already texted Jane to offer her the slot!
}`} />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  ...
                  as usual, NoShow analyzes each one, sends perfectly timed reminders, and fills
...
// Every request to NoShow includes this header automatically
const headers = {
  ...
  "Content-Type": "application/json",
        ...
        <section id="appointments">
          ...
          <p className="mt-2 text-sm text-gray-600">
            When your software sends an appointment to NoShow, the AI automatically scores
          ...
          <div className="mt-6 space-y-4">
            <EndpointBlock
              method="POST"
              path="/appointments"
              description="Send a new appointment to NoShow"
              requestBody={`{
...
→ NoShow immediately scheduled 2 reminders
...
→ Slot was instantly offered to the top waitlist match`}
        ...
        <section id="reminders">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Reminders are <strong>100% automatic</strong>. When you send an appointment to NoShow,
...
→ When a slot opens, higher scores get offered first`}
  ...
  "total": 12
        ...
        <section id="contacts">
          ...
          <p className="mt-2 text-sm text-gray-600">
            NoShow automatically builds a reliability profile for each client over time.
...
→ AI uses this to calibrate reminder intensity`}
        ...
        <section id="webhooks">
          ...
          <p className="mt-2 text-sm text-gray-600">
            NoShow can notify your software in real-time when things happen — like a reminder
          ...
          <div className="mt-4 rounded-xl border border-black/[0.06] bg-white p-4">
            <p className="text-sm font-semibold text-gray-900 mb-3">Events NoShow sends to you</p>

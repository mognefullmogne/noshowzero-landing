      ...
      {step === 3 && (
        <div className="rounded-2xl border border-black/[0.04] bg-white p-8 text-center shadow-xl shadow-black/[0.03]">
          ...
          <p className="mt-2 text-sm text-gray-500 max-w-md mx-auto">
            Il tuo account NowShow è pronto. {apiKey ? "Ecco la tua chiave API per iniziare — o vai alla dashboard dove trovi tutto quello che ti serve." : "Vai alla dashboard per generare una chiave API e iniziare l'integrazione."}
          </p>
